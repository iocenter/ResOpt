...
#ifndef BONMININTERFACEGRADIENTS_H
#define BONMININTERFACEGRADIENTS_H
 ...
 *
 */
class BonminInterfaceGradients : public TMINLP
{
private:
    ...
    void update(Index n, const Number *x);

public:
    BonminInterfaceGradients(BonminOptimizer *o);

    virtual ~BonminInterfaceGradients();
...
#endif // BONMININTERFACEGRADIENTS_H
