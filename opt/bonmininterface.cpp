...
{
    cout << "CalculateGradients() start" << endl;
    ...
    cout << "CalculateGradients() done running base case" << endl;
    ...
    cout << "CalculateGradients() starting setting up perturbations" << endl;
